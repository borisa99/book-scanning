...
export const convertToCsvArray = (books: (Book | null)[]) => {
  const csv: {
    "Action(SiteID=UK|Country=GB|Currency=GBP|Version=1193|CC=UTF-8)": string;
    CustomLabel: string;
    "*Category": string;
    "*Title": string;
    "*ConditionID": string;
    ...
    "*C:Language": string;
    "*C:Topic": string;
    "C:Book Series": string;
    "*C:Genre": string;
    "*C:Publisher": string;
    "*C:Format": string;
    "C:Original Language": string;
    "*C:Publication Year": number;
    "*C:Narrative Type": string;
    "C:Character": string;
    "*C:Type": string;
    "C:Edition": string;
    "C:Country/Region of Manufacture": string;
    "C:Features": string;
    "*C:Intended Audience": string;
    "C:Ex Libris": string;
    "C:Personalise": string;
    "C:Signed By": string;
    "C:Inscribed": string;
    "C:Personalised": string;
    "C:Vintage": string;
    "C:Signed": string;
    "C:Literary Movement": string;
    "C:Era": string;
    "C:Illustrator": string;
    "C:Time Period Manufactured": string;
    "C:Item Height": string;
    "C:Item Length": string;
    "C:Item Weight": string;
    "C:Item Width": string;
    "C:Number of Pages": string;
    "C:Unit Quantity": string;
    PicURL: string;
    "*Description": string;
  }[] = [];
  ...
  books.map((book) => {
    ...
    const obj = {
      ...
      CustomLabel: "SKU",
      "*Category": "261186",
      "*Title": book?.title_long ?? "Unknown",
      "*ConditionID": "3000",
      "*C:Author": book?.authors ?? "Unknown",
      "*C:Book Title": book?.title ?? "Unknown",
      "*C:Language": book?.language ?? "Unknown",
      "*C:Topic": "Unknown",
      "C:Book Series": "No",
      "*C:Genre": book?.subjects?.toString() ?? "Unknown",
      "*C:Publisher": book?.publisher ?? "Unknown",
      "*C:Format": book?.binding ?? "Unknown",
      "C:Original Language": book?.language ?? "Unknown",
      "*C:Publication Year": new Date(
        book?.date_published ?? "Unknown"
      ).getFullYear(),
      ...
      "C:Item Height":
        dimensions.height != null
          ? `${dimensions.height.toString()} Inches`
          : "Unknown",
      "C:Item Length":
        dimensions.length != null
          ? `${dimensions.length.toString()} Inches`
          : "Unknown",
      "C:Item Weight":
        dimensions.weight != null
          ? `${dimensions.weight.toString()} Pounds`
          : "Unknown",
      "C:Item Width":
        dimensions.width != null
          ? `${dimensions.width.toString()} Inches`
          : "Unknown",
      "C:Number of Pages": book?.pages?.toString() ?? "Unknown",
      "C:Unit Quantity": "1",
      PicURL: book?.image ?? "Unknown",
      "*Description":
